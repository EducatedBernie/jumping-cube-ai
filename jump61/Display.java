...
class Display extends TopLevel implements View, CommandSource, Reporter {
    ...
    Display(String title) {
        ...
        addMenuRadioButton("Options->Blue Auto", "blue",
                true, this::autoBlue);
        addMenuRadioButton("Options->Red Manual", "red",
                true, this::manualRed);
        addMenuRadioButton("Options->Red Auto", "red",
                false, this::autoRed);
        addMenuButton("Options->Set Seed", this::seed);
        addMenuButton("Options->Input Command", this::testButton);
        addMenuButton("Options->Custom size", this::size);
    ...
    void size(String dummy) {
        _commandQueue.offer("size " + getTextInput(
                "Input a size", "Custom Size",
                "QUESTION_MESSAGE", ""));
    }
    ...
    void seed(String dummy) {
        _commandQueue.offer("seed " + getTextInput(
                "Input a seed", "Custom Command",
                "QUESTION_MESSAGE", "seed"));
    }

    /**
     * Response to "New Game" button click.
     */
    void testButton(String dummy) {
        _commandQueue.offer(getTextInput(
                "Type a textual input command, or help for more",
                "Custom Command", "QUESTION_MESSAGE",
                "command"));
    }
